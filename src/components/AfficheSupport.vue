...
defineProps<Database["public"]["Tables"]["Support"]["Row"] & { Films: Tables<'Films'>[] } & { Genre: Tables<'Genre'>[] } & { Collection: Tables<'Collection'>[] }>()
</script>
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/3 mb-8 md:mb-0">
                    <img :src="image_support" alt="Support physique" class="w-full rounded-lg" />
                </div>
                <div class="md:w-2/3 md:pl-8">
                    <h1 class="text-3xl font-bold mb-4">{{ titre_support }}</h1>
                    <p class="text-lg mb-4">{{ prix_support }}</p>
